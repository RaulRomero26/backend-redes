...
const auraPool = mysql.createPool({
    host: process.env.DBHOSTAURA,
    user: process.env.DBUSERAURA,
    password: process.env.DBPASSWORDAURA,
    database: process.env.DBDATABASEAURA,
...
const auraPromisePool = auraPool.promise();
